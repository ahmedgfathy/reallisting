...
const DATABASE_URL = process.env.POSTGRES_URL || 
                     ...
                     process.env.listing_realestates_DATABASE_URL ||
                     process.env.PRISMA_DATABASE_URL;

if (!DATABASE_URL) {
  console.error('❌ CRITICAL: Missing database URL environment variable!');
  console.error('Expected one of:');
  console.error('  - POSTGRES_URL');
  console.error('  - listing_realestates_POSTGRES_URL');
  console.error('  - DATABASE_URL');
  console.error('  - listing_realestates_DATABASE_URL');
  console.error('Format: postgres://user:password@host:port/dbname?sslmode=require');
}
...
// JWT Secret - try multiple names
const JWT_SECRET = process.env.JWT_SECRET || 
                   process.env.listing_realestates_JWT_SECRET ||
