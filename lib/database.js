...
// Determine which database to use - support both standard and NEXT_PUBLIC prefixes
...
if (useSupabase) {
  ...
  console.warn('⚠️ WARNING: No Supabase credentials found in production. MySQL/Local storage might fail.');
} else {
