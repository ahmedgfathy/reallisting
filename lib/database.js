...
// Require POSTGRES_URL environment variable (no fallback)
const DATABASE_URL = process.env.POSTGRES_URL;

if (!DATABASE_URL) {
  console.error('❌ CRITICAL: Missing POSTGRES_URL environment variable!');
  console.error('Please set in Vercel: Settings → Environment Variables → POSTGRES_URL');
