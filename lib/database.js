...
const messages = {
  ...
  async createBatch(messagesData) {
    return await supabase.messages.createBatch(messagesData);
  },
  ...
  async deleteMultiple(ids) {
    return await supabase.messages.deleteMultiple(ids);
  },
...
async function getStats() {
  ...
  return {
    ...
    filters: await supabase.messages.getFilterValues()
  };
}
